...
const Header = () => {
  return (
    ...
    >
      <Icon sx={{ width: 96, height: 96, marginRight: "15px" }}>
        <svg
      ...
      >
        ...
        <Typography variant="subtitle1" sx={{ fontSize: "1.5rem" }}>
          software engineer, automation enthusiast & coffee addict
        </Typography>
      </Typography>
      <Typography
        variant="h1"
